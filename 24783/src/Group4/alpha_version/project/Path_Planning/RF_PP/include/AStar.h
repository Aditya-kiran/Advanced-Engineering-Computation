 ...
 * @param straddle_id : For now, this is not used, don't be confused by that.
...
public:
    ...
    void StoreStraddlePath(int straddle_id, route curr_route);
    void PrintStraddlePath(int straddle_id, route curr_route);

    route RetriveStraddlePath(int straddle_id);
...
public:
    std::vector<route> serve(std::vector<int> straddle_numbers, std::vector<int> from_ids, std::vector<int> to_ids, std::vector<double> start_working_time);
    std::vector<route> multi_pp(std::vector<int> straddle_numbers, std::vector<int> from_ids, std::vector<int> to_ids, std::vector<double> start_working_time);
    void FunctionTest();
    void init();
